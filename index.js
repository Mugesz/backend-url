    ...
    try {
        ...
        jsonwebtoken.verify(token, secretKey, async (err, decoded) => {
            ...
            if (result.modifiedCount === 1) {
                ...
                res.redirect(`https://master--imaginative-salamander-998fef.netlify.app/`);
            } else {
...
app.post('/forget-password', async (req, res) => {
    try {
        ...
        const info = await transporter.sendMail({
            ...
            text: `Click the following link to reset your password: https://url-shortener-vignesh.netlify.app/dashboard/reset-password/${token}`
        });
